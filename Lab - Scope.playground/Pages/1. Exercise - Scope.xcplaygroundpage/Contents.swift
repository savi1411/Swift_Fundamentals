...
//print("The value of foo is \(foo)")
// O escopo da constante foo está restrito à função
...
// A variável x tem um escopo global em relação à função
...
greeting(greeting: "E aí", name: "Tim")
greeting(greeting: nil, name: "Tim")
/*:
...
let ferrari = Car(make: "Ferrari", model: "Testarossa", year: 2000)
