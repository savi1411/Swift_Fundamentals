...
var favoriteBook = Book(title: "Swift in half an hour, sleeping", author: "Tim Cook", pages: 1000, price: 24.99)
//print(favoriteBook.title)
//favoriteBook.title = "Swift in half an hour, sleeping"
//favoriteBook.author = "Tim Cook"
//favoriteBook.pages = 1000
//favoriteBook.price = 24.99

print("Meu livro favorito é \(favoriteBook.title), que foi escrito por \(favoriteBook.author). O livro tem \(favoriteBook.pages) páginas e custa \(favoriteBook.price)")
...
someonesHeight = Height(heightInCentimeters: 165.1)
 ...
 */
var myHeight = Height(heightInCentimeters: 182)
