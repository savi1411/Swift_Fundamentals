 ...
 */
var carlos = User(name: "Carlos", age: 47, height: 1.82, weight: 89, activityLevel: 1)
print("My nome é \(carlos.name). Eu tenho \(carlos.age), \(carlos.height) de altura e peso \(carlos.weight). O meu nível de atividade é \(carlos.activityLevel)")
...
struct Distance {
    ...
    init(meters: Double) {
        self.meters = meters
        self.feet = meters * 3.2084
    }
    
    init(feet: Double) {
        self.feet = feet
        self.meters = feet / 3.2084
    }
}
 ...
 */
var mile = Distance(meters: 1000)
print(mile.feet)

mile = Distance(feet: 3208.4)
print(mile.meters)
