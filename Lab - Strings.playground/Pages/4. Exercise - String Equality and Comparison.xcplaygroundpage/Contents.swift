 ...
 */
let nameInCaps = "Carlos Savi"
let name = "carlos savi"
...
if nameInCaps.lowercased() == name.lowercased() {
    print("Os nomes \(nameInCaps.lowercased()) e \(name.lowercased()) são iguais")
} else {
    print("Os nomes \(nameInCaps.lowercased()) e \(name.lowercased()) são diferentes")
}
...
if junior.hasSuffix("Jr.") {
    print("Encontramos uma 2ª geração!")
}
