...
// Versão com Observers - design by Andrey; made by Jonatan
//class Fighter: Spaceship {
//    var weapon = ""
//    var remainingFirePower = 5 {
//        willSet {
//            if newValue > remainingFirePower {
//                print("Destroyer charged with \(newValue) shoots")
//            }
//
//            if remainingFirePower > 0 {
//                print("Destroyer has \(remainingFirePower) remaining fire power: ")
//            } else {
//                print("You have no more fire power.")
//            }
//        }
...
//print(falcon.weapon)
// A propriedade weapon pertence apenas à subclasse
/*:
